# rapid-timer-decorator

> Rapid measure function execution time

[![PyPI version](https://badge.fury.io/py/rapid-timer-decorator.svg)](https://pypi.org/project/rapid-timer-decorator/)
...
```bash
pip install rapid-timer-decorator
```
...
# Basic usage
result = decorator("your input here")
print(result)
```
...
from rapid_timer_decorator import batch
